"""
Django settings for MonitoringSoftwareMarketplaces project.
...
ROOT_URLCONF = 'MonitoringSoftwareMarketplaces.router'
...
WSGI_APPLICATION = 'MonitoringSoftwareMarketplaces.wsgi.application'
